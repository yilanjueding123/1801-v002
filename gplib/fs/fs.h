...
#define CHEZAI_MP3					0
#define MAX_FILE_NUM				12		//指定最多可以打开的文件的数目
...
#define FS_FORMAT_SPEEDUP			0		// support fs format speedup, the file system will malloc 8kB buffer
...
#define C_MAX_DIR_LEVEL		5				// Max directory deepth level
...
#define FD32_LFNMAX  		255				// Max length for a long file name, including the NULL terminator
	...
	#define C_FS_FORMAT_BUFFER_SECTOR_SIZE		16
