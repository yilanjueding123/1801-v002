...
#define DYNAMIC_MCLK                1  /* jandy(dominant) add for dynamic MCLK adjust, 2008/11/17 */
#if (defined DYNAMIC_MCLK) && (DYNAMIC_MCLK==1)  /* jandy(dominant) add for dynamic MCLK adjust, 2008/11/17 */
	#define INIT_MCLK                   96000000
	#define INIT_MHZ                    (INIT_MCLK/1000000)
#else
	#define MCLK                        96000000
	#define MHZ                         (MCLK/1000000)
#endif

#if DBG_MESSAGE==CUSTOM_OFF
#define SDRAM_SIZE					SD_16Mb			//1x16 SDRAM
#define SDRAM_END_ADDR              0x001FFFFF		//1x16 SDRAM
#else
#define SDRAM_SIZE					SD_64Mb			//4x16 SDRAM
#define SDRAM_END_ADDR              0x007FFFFF		//4x16 SDRAM
#endif

#define SDRAM_START_ADDR            0x00000000
#define ISRAM_START_ADDR            0xF8000000
#define ISRAM_END_ADDR              0xF8000F00      // The last 256 bytes(0xF8003F00~0xF8003FFF) are reserved for ROM code and exception table
#define IRAM_SWAITCH_FLAG_START     0xF8000A00        // jandy add for binswitcher
#define IRAM_SWAITCH_FLAG_END       0xF8000ADF        // jandy add for binswitcher
...
#define __GPIO_PAD_DEFINE__
     ...
     #define UART_TX_RX_POS              UART_TX_IOE2__RX_IOE3//UART_TX_IOF7
#elif MINI_DVR_BOARD_VERSION == GPL32680_MINI_DVR_EMU_64PIN  
     #define UART_TX_RX_POS              UART_TX_IOF7
#else
 	 //#define UART_TX_RX_POS              UART_TX_IOF7
 	 #if DBG_MESSAGE==CUSTOM_OFF
 	 #define UART_TX_RX_POS              UART_TX_IOH2__RX_IOH3	//量产版本
 	 #else
 	 #define UART_TX_RX_POS              UART_TX_IOF7			//debug版本
 	 //#define UART_TX_RX_POS              UART_TX_IOB2__RX_IOB1	//debug版本
 	 #endif
#endif
     ...
     #define CMOS_DRIVING                IO_DRIVING_16mA
...
#if MINI_DVR_BOARD_VERSION <= GPL32680_MINI_DVR_EMU_V2_0 || MINI_DVR_BOARD_VERSION == GPL32680_MINI_DVR_DEMO_BOARD
	 #define SD_DRIVING                  IO_DRIVING_12mA /* IOC only 4mA/8mA can choice, IOD: 4mA/8mA/12mA/16mA can choice*/
 #else
 	 #define SD_DRIVING                  IO_DRIVING_4mA
 #endif
...
//==========================================================================================//
    ...
    #define UART_TX_IOF7								0x00000004
