...
#define AVI_ENCODE_FAST_SWITCH_EN		C_CYCLIC_VIDEO_RECORD		//0: disable, 1:enable; video encode fast stop and start 
...
#elif VIDEO_ENCODE_MODE == C_VIDEO_ENCODE_FIFO_MODE
	#define AVI_ENCODE_CSI_BUFFER_NO		6  	//fix to 2 
#endif
...
#define AVI_FILE_MAX_RECORD_SIZE		1909*1024*1024	//1909MB = 1.86GB

#define AUD_FILE_MAX_RECORD_SIZE		300*AUD_REC_SAMPLING_RATE*2	//2GB

//avi packer buffer
//2011-9-23 11:13
//#define FileWriteBuffer_Size			6*32*1024		//avi pack buffer size, must multiple 32k 
//#define FileWriteBuffer_Size			27*32*1024		//avi pack buffer size, must multiple 32k 
#define FileWriteBuffer_Size			(27-3)*32*1024		//avi pack buffer size, must multiple 32k 
										//"27-3" 是为了给"单帧buf"加大(32*2)KB 和 给"程序&RAM余量"加大 32KB.
...
/* //added by xiangyong 2011-10-7 16:23
//gpy0500 command
