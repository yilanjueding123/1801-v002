...
void gpio_init(void)
{
    ...
    /* release XA19 ~ XA22 */
    //R_MEM_IO_CTRL &= ~0x1E;
    R_MEM_IO_CTRL &= ~0x201E;	//xiangyong 竅馱萇趕硌絳党蜊
    
    R_MEM_IO_CTRL &= ~0x0180;	//XA12/XA13 as IO
...
/* UART Pad Dispacher START */  
    ...
    funpos0 &= ~(1<<0);
    iosrsel |= (1<<15);
#elif (UART_TX_RX_POS == UART_TX_IOF7)
	R_FUNPOS2 |= 1;
...
{
#if (BOARD_TYPE == BOARD_TK_V4_1) || (BOARD_TYPE == BOARD_GPY0200_EMU_V2_0) || (BOARD_TYPE == BOARD_TK35_V1_0) || (BOARD_TYPE == BOARD_TK_A_V2_0)
